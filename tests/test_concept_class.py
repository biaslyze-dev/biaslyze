...
from biaslyze.text_representation import Token, TextRepresentation
...
def test_keyword_can_replace_token():
    ...
    keyword = Keyword(text="she", function=["subject"], category="pronoun")
    assert keyword.can_replace_token(token=Token(text="she", start=11, end=14, whitespace_after=" "))


def test_keyword_equal_to_token():
    """Test the Keyword class equal_to_token method."""
    keyword = Keyword(text="she", function=["subject"], category="pronoun")
    assert keyword.equal_to_token(token=Token(text="she", start=0, end=3, whitespace_after=" "))
    assert not keyword.equal_to_token(token=Token(text="he", start=0, end=2, whitespace_after=" "))


def test_keyword_get_keyword_in_style_of_token():
    """Test the Keyword class get_keyword_in_style_of_token method."""
    keyword = Keyword(text="she", function=["subject"], category="pronoun")
    assert keyword.get_keyword_in_style_of_token(token=Token(text="He", start=0, end=3, whitespace_after=" ")) == "she"
...
def test_concept_get_present_keywords():
    ...
    present_keywords = concept.get_present_keywords(text_representation=text_representation)
